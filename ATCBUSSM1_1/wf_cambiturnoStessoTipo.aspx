	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<asp:customvalidator id="cvTipoUtente" runat="server" ErrorMessage="Solamente gli accertatori possono richiedere congedi e cambi turno."
				Display="None"></asp:customvalidator><asp:customvalidator id="cvOnModifica" runat="server" ErrorMessage="Non è possibile modificare questa richiesta perché non sei tu il richiedente."
