...
#End Region
  ...
  Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Try
      ...
      If (m_strVehicleState = "DML") Then
        lblTitle.Text = "Reintegro veicoli demoliti"
        btnExecute.Text = "Reintegra"
        btnExecute.Attributes.Add("onclick", "return(confirm('Sei sicuro di voler reintegrare il veicolo?'));")
      Else
        lblTitle.Text = "Demolizione veicoli"
        btnExecute.Text = "Demolisci"
        btnExecute.Attributes.Add("onclick", "return(confirm('Sei sicuro di voler demolire il veicolo?'));")
      End If
  ...
  Private Sub btnExecute_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExecute.Click
    ...
    If (m_strVehicleState = "DML") Then
      RC = atcbWUser.RecoverDemolishedVehicle(m_intUserID, m_intVehicleID, m_strVehiclePlate, txtNotes.Text.Trim)
    Else
      RC = atcbWUser.DemolishVehicle(m_intUserID, m_intVehicleID, m_strVehiclePlate, txtNotes.Text.Trim)
    End If
    If RC Then
