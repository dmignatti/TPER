<%@ Page Language="vb" AutoEventWireup="false" Codebehind="wf_giorniriposo.aspx.vb" Inherits="ATCBussm1.wf_giorniriposo"%>
...
<!--
	function Stampa() 
	{
        ...
        var id =txt.value;
			...
			window.open('wf_stampariposi.aspx','rel')
		...
		<form id="FrmRiposi" method="post" runat="server">
			...
			<DIV align="center"><asp:panel id="pnlGiorniSpeciali" runat="server" Width="700px" Visible="true">
					<FIELDSET style="WIDTH: 100%"><LEGEND class="label">
						...
						<asp:datagrid id=dgRiposi runat="server" Width="100%" Visible="TRUE" CssClass="grid" DataSource="<%# DsRiposi1 %>" DataMember="Riposi" DataKeyField="Id" GridLines="Vertical" AutoGenerateColumns="False" CellPadding="2" UseAccessibleHeader="True">
