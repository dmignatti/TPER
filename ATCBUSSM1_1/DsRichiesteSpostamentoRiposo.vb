...
Public Class DsRichiesteSpostamentoRiposo
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DsRichiesteSpostamentoRiposo = CType(MyBase.Clone,DsRichiesteSpostamentoRiposo)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DsRichiesteSpostamentoRiposo"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DsRichiesteSpostamentoRiposo.xsd"
    ...
    Public Class RichiesteSpostamentoRiposoDataTable
        ...
        Public Overloads Function AddRichiesteSpostamentoRiposoRow(ByVal Approvatore As String, ByVal IdRichiesta As System.Guid, ByVal IdAccertatore As Integer, ByVal TipoSpostamento As String, ByVal DalGiorno As Date, ByVal AlGiorno As Date, ByVal DalleOre As Long, ByVal AlleOre As Long, ByVal StatoApprovazione As String, ByVal DataApprovazione As Date, ByVal IdApprovatore As Integer, ByVal ts As Date) As RichiesteSpostamentoRiposoRow
            Dim rowRichiesteSpostamentoRiposoRow As RichiesteSpostamentoRiposoRow = CType(Me.NewRow,RichiesteSpostamentoRiposoRow)
            rowRichiesteSpostamentoRiposoRow.ItemArray = New Object() {Approvatore, IdRichiesta, IdAccertatore, TipoSpostamento, DalGiorno, AlGiorno, DalleOre, AlleOre, StatoApprovazione, DataApprovazione, IdApprovatore, ts}
        ...
        Private Sub InitClass()
            ...
            Me.Constraints.Add(New UniqueConstraint("DsRichiesteSpostamentoRiposoKey1", New DataColumn() {Me.columnIdRichiesta}, true))
