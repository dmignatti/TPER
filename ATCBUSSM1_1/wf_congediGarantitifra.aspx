<%@ Page Language="vb" AutoEventWireup="false" Codebehind="wf_congediGarantitifra.aspx.vb" Inherits="ATCBussm1.wf_congediGarantitiFra"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>wf_congedigarantitifra</title>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<table id="Table01" class="Back" cellSpacing="0" cellPadding="0" width="100%" align="center">
				...
				<tr>
					<td style="PADDING-BOTTOM: 0px; PADDING-LEFT: 5px; PADDING-RIGHT: 5px; PADDING-TOP: 0px"
						vAlign="top">
						<h6>Richieste congedi garantiti frazionati<br>
						...
						<hr SIZE="1" noShade>
						<asp:validationsummary id="vsErrori" runat="server" HeaderText="Attenzione!" Width="100%" CssClass="Error"></asp:validationsummary><asp:label id=lblRichieste runat="server" CssClass="label" Visible='<%# DataBinder.Eval(DsRichiesteCongediGarantitiFra1, "Tables[RichiesteCongediGarantitiFra]").Rows.Count <= 0 %>'>Non ci sono richieste.</asp:label><asp:button id="btnAddRichiesta" runat="server" CssClass="bottone" CausesValidation="False"
							Text="Nuovo congedo garantito frazionato"></asp:button><asp:datagrid id=dgCongediFrazionati runat="server" Width="100%" CssClass="grid" Visible='<%# DataBinder.Eval(DsRichiesteCongediGarantitiFra1, "Tables[RichiesteCongediGarantitiFra]").Rows.Count > 0 %>' UseAccessibleHeader="True" DataSource="<%# DsRichiesteCongediGarantitiFra1 %>" DataMember="RichiesteCongediGarantitiFra" DataKeyField="IdRichiesta" AutoGenerateColumns="False" GridLines="None">
							<Columns>
								...
								<asp:TemplateColumn HeaderText="Data del congedo">
									<ItemTemplate>
									...
									<EditItemTemplate>
										...
										<asp:CustomValidator id="cvMinData" runat="server" Display="None" ErrorMessage="Si può chiedere un congedo garantito frazionato solo fino alle 18:00 del giorno precedente."
								...
								<asp:TemplateColumn HeaderText="Alle Ore">
									...
									<EditItemTemplate>
										...
										<asp:CustomValidator OnServerValidate="cvAlleOre_OnServerValidate" id="cvAlleOre" runat="server" ErrorMessage="E' possibile richiedere congedi garantiti frazionati di minimo 15 minuti."
											Display="None"></asp:CustomValidator>
									</EditItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn Visible="False" HeaderText="Accetto intero">
									<ItemTemplate>
										<asp:CheckBox ID="chkInteroL" Runat="server" Enabled ="false" Text ="Accetto" Checked='<%# DataBinder.Eval(Container, "DataItem.Intero") %>' >
										</asp:CheckBox>
									</ItemTemplate>
									<EditItemTemplate>
										<asp:CheckBox ID="chkIntero" Runat="server" Enabled ="true" Text="Accetto" Checked='<%# DataBinder.Eval(Container, "DataItem.Intero") %>' >
										</asp:CheckBox>
									</EditItemTemplate>
								</asp:TemplateColumn>
			...
			<asp:customvalidator id="cvOnModifica" runat="server" ErrorMessage="Non è possibile modificare o eliminare questa richiesta."
