<%@ Page Language="vb" AutoEventWireup="false" Codebehind="wf_congedifrazionati.aspx.vb" Inherits="ATCBussm1.wf_congedifrazionati"%>
			...
			<table id="Table01" class="Back" cellSpacing="0" cellPadding="0" width="100%" align="center">
				...
				<tr>
					<td style="PADDING-BOTTOM: 0px; PADDING-LEFT: 5px; PADDING-RIGHT: 5px; PADDING-TOP: 0px"
						vAlign="top">
						<h6>Richieste congedi frazionati<br>
						...
						<hr SIZE="1" noShade>
						<asp:validationsummary id="vsErrori" runat="server" CssClass="Error" Width="100%" HeaderText="Attenzione!"></asp:validationsummary><asp:label id=lblRichieste runat="server" CssClass="label" Visible='<%# DataBinder.Eval(DsRichiesteCongediFrazionati1, "Tables[RichiesteCongediFrazionati]").Rows.Count <= 0 %>'>Non ci sono richieste.</asp:label><asp:button id="btnAddRichiesta" runat="server" CssClass="bottone" Text="Nuovo congedo frazionato"
							CausesValidation="False"></asp:button><asp:datagrid id=dgCongediFrazionati runat="server" CssClass="grid" Width="100%" Visible='<%# DataBinder.Eval(DsRichiesteCongediFrazionati1, "Tables[RichiesteCongediFrazionati]").Rows.Count > 0 %>' GridLines="None" AutoGenerateColumns="False" DataKeyField="IdRichiesta" DataMember="RichiesteCongediFrazionati" DataSource="<%# DsRichiesteCongediFrazionati1 %>" UseAccessibleHeader="True">
							<Columns>
								...
								<asp:TemplateColumn HeaderText="Data del congedo">
									...
									<EditItemTemplate>
										...
										<asp:CustomValidator id="cvMinData" runat="server" Display="None" ErrorMessage="Si può chiedere un congedo frazionato solo fino alle 18:00 del giorno precedente."
								...
								<asp:TemplateColumn HeaderText="Alle Ore">
									...
									<EditItemTemplate>
										...
										<asp:CustomValidator id="cvAlleOre" runat="server" Display="None" ErrorMessage="E' possibile richiedere congedi frazionati di minimo 15 minuti."
