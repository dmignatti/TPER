Public Class wf_tariffariorimozione
...
#End Region
  ...
  Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Try
      ...
      m_Tarfs = New supTarfIntervals(supTarfIntervals.TarfType.tteForRimozione)
      hlkAddNew.Visible = m_Tarfs.CanAddNew
      hlkAddNew.NavigateUrl = "wf_editrimozione.aspx?" & _
  ...
  Private Sub Fill()
    ...
    Try
      ...
      row.Cells.Add(GetCell(3, "Operazioni possibili", mk_CSS_TITLEGRP, 3 * mk_COLLINK_WIDTH, mk_CellHeight))
      tbl.Rows.Add(row)
  ...
  Private Sub AddItem(ByRef ti As supTarfInterval)
    ...
    sNavigateUrl = "wf_viewrimozione.aspx?" & _
    ...
    If ti.CanUpdate Then
      sNavigateUrl = "wf_editrimozione.aspx?" & _
                     atcbConstant.QS_DateBegin & "=" & supFunction.FormatDate(ti.DataInizio, supFunction.supDateFormatEnum.dfeStandard) & "&" & _
                     atcbConstant.QS_DateEnd & "=" & supFunction.FormatDate(ti.DataFine, supFunction.supDateFormatEnum.dfeStandard) & "&" & _
                     atcbConstant.QS_ModuleID & "=" & Request.QueryString(atcbConstant.QS_ModuleID)
    ...
    If ti.CanDelete Then
      sNavigateUrl = "wf_deleterimozione.aspx?" & _
                     atcbConstant.QS_DateBegin & "=" & supFunction.FormatDate(ti.DataInizio, supFunction.supDateFormatEnum.dfeStandard) & "&" & _
                     atcbConstant.QS_DateEnd & "=" & supFunction.FormatDate(ti.DataFine, supFunction.supDateFormatEnum.dfeStandard) & "&" & _
                     atcbConstant.QS_ModuleID & "=" & Request.QueryString(atcbConstant.QS_ModuleID)
