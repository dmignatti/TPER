<%@ Page Language="vb" AutoEventWireup="false" Codebehind="wf_giustificativigestori.aspx.vb" Inherits="ATCBussm1.wf_giustificativigestori"%>
			...
			<table id="Table01" class="Back" cellSpacing="0" cellPadding="0" width="100%" align="center">
				...
				<tr>
					<td style="PADDING-BOTTOM: 0px; PADDING-LEFT: 5px; PADDING-RIGHT: 5px; PADDING-TOP: 0px"
						...
						<hr SIZE="1" noShade>
						<asp:validationsummary id="vsErrori" runat="server" CssClass="Error" Width="100%" HeaderText="Attenzione!"></asp:validationsummary>
						<P><asp:label id=lblRichieste runat="server" CssClass="label" Visible='<%# DataBinder.Eval(DsGiustificativi1, "Tables[Accertatori_GiustificativoRichiesta]").Rows.Count <= 0 %>'>Non ci sono richieste.</asp:label><br>
							<asp:Label style="Z-INDEX: 0" id="Label2" class="label" runat="server">Accertatore: </asp:Label>
							<asp:DropDownList style="Z-INDEX: 0" id=ddlAccertatori  DataValueField="ID" DataTextField="NomeCognome" DataSource="<%# DsGiustificativi1 %>" DataMember="TPER_Accertatori" Runat="server" AutoPostBack ="True">
							</asp:DropDownList><br>
							<asp:label id="Label6" class="label" runat="server">Causali giustificativi: </asp:label><asp:dropdownlist id=ddlCausali Runat="server" DataMember="Accertatori_Causale" DataSource="<%# DsGiustificativi1 %>" DataTextField="Nome" DataValueField="ID"></asp:dropdownlist>
							<asp:button id="btnAddRichiesta" runat="server" CssClass="bottone" Text="Nuova richiesta giustificativo"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="Accertatori_GiustificativoCausaleId" SortExpression="Accertatori_GiustificativoCausaleId"
										Visible="False" ReadOnly="True" HeaderText="Accertatori_GiustificativoCausaleId"></asp:BoundColumn>
									<asp:BoundColumn DataField="Frazionato" SortExpression="Frazionato" Visible="False" ReadOnly="True"
										HeaderText="Frazionato"></asp:BoundColumn>
									<asp:BoundColumn DataField="DefaultApprovato" SortExpression="DefaultApprovato" Visible="False" ReadOnly="True"
										HeaderText="Appr"></asp:BoundColumn>
									<asp:BoundColumn DataField="PreavvisoGG" SortExpression="PreavvisoGG" Visible="False" ReadOnly="True"
										HeaderText="Preavv"></asp:BoundColumn>
									<asp:BoundColumn DataField="NrMaxGG" SortExpression="NrMaxGG" Visible="False" ReadOnly="True" HeaderText="NrMaxGG"></asp:BoundColumn>
									<asp:TemplateColumn HeaderText="Data da">
										<ItemTemplate>
											<asp:Label id="Label1" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.DataDa", "{0:d}") %>'>
											</asp:Label>
										</ItemTemplate>
										<EditItemTemplate>
											...
											<asp:CustomValidator id="cvMinData" runat="server" Display="None" ErrorMessage="Non si può inserire una richiesta di giustificativo passata."
									...
									<asp:TemplateColumn HeaderText="Data a">
										<ItemTemplate>
											<asp:Label id="Label9" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.DataA", "{0:d}") %>'>
											</asp:Label>
										</ItemTemplate>
										<EditItemTemplate>
