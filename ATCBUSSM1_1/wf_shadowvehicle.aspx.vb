...
#End Region
  ...
  Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Try
      ...
      If (m_strVehicleState = "SHA") Then
        lblTitle.Text = "Reintegro veicoli shadowed"
        btnExecute.Text = "Reintegra"
        btnExecute.Attributes.Add("onclick", "return(confirm('Sei sicuro di voler reintegrare il veicolo?'));")
      Else
        lblTitle.Text = "Shadowing veicoli"
        btnExecute.Text = "Shadow"
        btnExecute.Attributes.Add("onclick", "return(confirm('Sei sicuro di volere lo shadowing del veicolo?'));")
      End If
  ...
  Private Sub btnExecute_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExecute.Click
    ...
    If (m_strVehicleState = "SHA") Then
      RC = atcbWUser.RecoverShadowedVehicle(m_intUserID, m_intVehicleID, m_strVehiclePlate, txtNotes.Text.Trim)
    Else
      RC = atcbWUser.ShadowVehicle(m_intUserID, m_intVehicleID, m_strVehiclePlate, txtNotes.Text.Trim)
    End If
    If RC Then
