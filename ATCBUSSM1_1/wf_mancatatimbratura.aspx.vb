Public Class wf_mancatatimbratura
...
#Region " Web Form Designer Generated Code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    " StatoApprovazione, MT.DataApprovazione, MT.ApprovatoDa, MT.CreatedOn, MT.DataIn" & _
    "serimento FROM dbo.Accertatori_MancataTimbratura MT LEFT OUTER JOIN dbo.ATC_Uten" & _
    "ti U ON MT.ApprovatoDa = U.ID WHERE (MT.Data >= DATEADD(d, DATEDIFF(d, 0, GETDAT" & _
    "E()), 0)) AND (MT.AccertatoreId = @IdAccertatore) ORDER BY MT.CreatedOn DESC"
...
#End Region
  ...
  Const Modulo As String = "wf_mancatatimbratura.aspx"
  ...
  Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    daMancataTimbratura.SelectCommand.Parameters("@IDAccertatore").Value = oUtente.ID
  ...
  Private Sub btnAddRichiesta_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAddRichiesta.Click
    ...
    fnc.ScriviLog(oUtente.IDUser, Modulo, "Click nuova richiesta congedo frazionato", Session("IPAddress"))
  End Sub
  ...
  Private Sub dgCongediFrazionati_EditCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles dgCongediFrazionati.EditCommand
    ...
    If cvOnModifica.IsValid Then
      ...
      Page.DataBind()
      btnAddRichiesta.Enabled = False
      fnc.ScriviLog(oUtente.IDUser, "wf_mancatatimbratura.aspx", "Inizio modifica congedo", Session("IPAddress"))
    End If
  End Sub
  ...
  Private Sub dgCongediFrazionati_UpdateCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles dgCongediFrazionati.UpdateCommand
    If Me.IsValid Then
      ...
      fnc.ScriviLog(oUtente.IDUser, "wf_mancatatimbratura.aspx", oUtente.Nome & "-" & "Confermato inserimento/modifica congedo ", Session("IPAddress"))
    End If
  End Sub
  ...
  Private Sub dgCongediFrazionati_DeleteCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles dgCongediFrazionati.DeleteCommand
    ...
    If cvOnModifica.IsValid Then
      ...
      If Not dr Is Nothing Then
        dr.Delete()
        daMancataTimbratura.Update(DsMancataTimbratura1, TableMT)
        fnc.ScriviLog(oUtente.IDUser, "wf_mancatatimbratura.aspx", "Eliminato congedo", Session("IPAddress"))
      End If
      dgCongediFrazionati_CancelCommand(source, e)
    End If
  End Sub
