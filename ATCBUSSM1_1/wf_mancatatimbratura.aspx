<%@ Page Language="vb" AutoEventWireup="false" Codebehind="wf_mancatatimbratura.aspx.vb" Inherits="ATCBussm1.wf_mancatatimbratura"%>
			...
			<table id="Table01" class="Back" cellSpacing="0" cellPadding="0" width="100%" align="center">
				...
				<tr>
					<td style="PADDING-BOTTOM: 0px; PADDING-LEFT: 5px; PADDING-RIGHT: 5px; PADDING-TOP: 0px"
						...
						<hr SIZE="1" noShade>
						<asp:validationsummary id="vsErrori" runat="server" CssClass="Error" Width="100%" HeaderText="Attenzione!"></asp:validationsummary><asp:label id=lblRichieste runat="server" CssClass="label" Visible='<%# DataBinder.Eval(DsMancataTimbratura1, "Tables[Accertatori_MancataTimbratura]").Rows.Count <= 0 %>'>Non ci sono richieste.</asp:label><asp:button id="btnAddRichiesta" runat="server" CssClass="bottone" Text="Nuova mancata timbratura"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="CreatedOn" SortExpression="CreatedOn" ReadOnly="True" HeaderText="Data della richiesta"></asp:BoundColumn>
								<asp:TemplateColumn HeaderText="Data della mancata timbratura">
									...
									<EditItemTemplate>
										...
										<asp:CustomValidator id="cvMinData" runat="server" Display="None" ErrorMessage="Data inserimento deve coincidere con data mancata timbratura."
								...
								<asp:TemplateColumn HeaderText="Seconda timbratura">
									...
									<EditItemTemplate>
										...
										<asp:CustomValidator OnServerValidate="cvAlleOre_OnServerValidate" id="cvAlleOre" runat="server" ErrorMessage="Controllare la correttezza degli orari delle timbrature."
