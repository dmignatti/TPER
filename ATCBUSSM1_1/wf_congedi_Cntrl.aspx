...
<HTML>
	...
	<body>
		<form id="Form1" method="post" runat="server">
							...
							<Columns>
								...
								<asp:TemplateColumn HeaderText="Al Giorno">
									...
									<EditItemTemplate>
										...
										<asp:CustomValidator id="cvDataDalFestiva" runat="server" ErrorMessage="Non è possibile che il primo giorno di richiesta congedo sia festivo o di riposo."
			...
			<asp:customvalidator id="cvOnModificaCongedo" runat="server" Display="None" ErrorMessage="Non è possibile modificare questo congedo."></asp:customvalidator><asp:customvalidator id="cvOnEliminaCongedo" runat="server" Display="None" ErrorMessage="Non è possibile eliminare questo congedo."></asp:customvalidator><asp:customvalidator id="cvTipoUtente" runat="server" Display="None" ErrorMessage="Solamente gli accertatori possono richiedere congedi e cambi turno."></asp:customvalidator>
