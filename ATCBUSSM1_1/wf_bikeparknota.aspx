<%@ Page Language="vb" AutoEventWireup="false" Codebehind="wf_bikeparknota.aspx.vb" Inherits="ATCBussm1.wf_bikeparknota" %>
<%@ Register TagPrefix="uc1" TagName="wc_checkpermission" Src="wc_checkpermission.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>wf_bikeparknota</title>
				...
				<tr>
					<td style="PADDING-RIGHT: 5px; PADDING-LEFT: 5px; PADDING-BOTTOM: 0px; PADDING-TOP: 0px"
						...
						<div>
							...
							<asp:TextBox Width="160px" id="txtData" runat="server"  Text='<%# format(DataBinder.Eval(DsBiglietterie1, "Tables[BikePark_Note].DefaultView.[0].Data"),"dd/MM/yyyy") %>'>
							</asp:TextBox>
						...
						<div>
							...
							<asp:dropdownlist id=ddlTipoNota runat="server" DataSource="<%# DsBiglietterie1 %>" DataMember="BikePark_TipoNota" DataTextField="Tipo" DataValueField="IdTipoNota" SelectedValue='<%# DataBinder.Eval(DsBiglietterie1, "Tables[BikePark_Note].DefaultView.[0].IdTipoNota") %>'>
							</asp:dropdownlist></div>
						<div>
							<asp:Label id="lblNota" runat="server" AssociatedControlID="txtNota" Width="60px">Nota:</asp:Label><br>
							<asp:TextBox Width="100%" id="txtNota" runat="server" TextMode="MultiLine" Text='<%# DataBinder.Eval(DsBiglietterie1, "Tables[BikePark_Note].DefaultView.[0].Nota") %>'>
							</asp:TextBox></div>
						<hr noShade SIZE="1">
