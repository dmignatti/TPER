...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="wf_editrimozione.aspx.vb" Inherits="ATCBussm1.wf_editrimozione" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
  <HEAD>
    <title>wf_editrimozione</title>
    ...
    <form id="Form1" method="post" runat="server">
      <div align="center">
        ...
        <table align="center">
          ...
          <tr vAlign="top">
            <td align="center"><asp:table id="tbl" Runat="server" CssClass="supGDATCSession_Table" CellPadding="0" CellSpacing="0"></asp:table></td>
          </tr>
          <tr vAlign="top">
