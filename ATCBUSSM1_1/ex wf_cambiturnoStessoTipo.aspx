...
<HTML>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<table id="Table01" class="Back" cellSpacing="0" cellPadding="0" width="100%" align="center">
				...
				<tr>
					<td style="PADDING-BOTTOM: 0px; PADDING-LEFT: 5px; PADDING-RIGHT: 5px; PADDING-TOP: 0px"
						vAlign="top">
						<h6><FONT color="darkblue">Cambi turno giornalieri (stessa tipologia)</FONT> <span class="label">
								(Sono visibili solamente i cambi turno ancora da effettuare)</span></h6>
						<hr SIZE="1" noShade>
						<asp:validationsummary id="vsErrori" runat="server" CssClass="error" Width="100%" HeaderText="Attenzione!"></asp:validationsummary><asp:label id=lblCambiTurno runat="server" CssClass="label" Visible='<%# DataBinder.Eval(DsCambiTurnoGiornalieriStessoTipo1, "Tables[RichiesteCambiTurnoStessoTipo]").Rows.Count <= 0 %>'>Non ci sono cambi turno.</asp:label><asp:button id="btnNuovaRichiesta" runat="server" CssClass="bottone" Text="Nuovo cambio turno"></asp:button><asp:panel id="pnlData" runat="server" Visible="False">
							<HR SIZE="1" noShade>
							...
							<asp:CustomValidator id="cvEccezioni" runat="server" Display="None" ErrorMessage="Superato numero cambi giornalieri nel mese"></asp:CustomValidator>
							...
							<asp:CustomValidator id="cvSoloUnCambio" runat="server" Display="None" ErrorMessage="E' possibile richiedere solamente due cambi turno al giorno."></asp:CustomValidator>
							...
							<HR SIZE="1" noShade>
						</asp:panel><asp:datagrid id=dgCambiTurnoGiornalieriStessoTipo runat="server" CssClass="grid" Width="896px" Visible='<%# DataBinder.Eval(DsCambiTurnoGiornalieriStessoTipo1, "Tables[RichiesteCambiTurnoStessoTipo]").Rows.Count > 0 %>' GridLines="None" AutoGenerateColumns="False" DataMember="RichiesteCambiTurnoStessoTipo" DataSource="<%# DsCambiTurnoGiornalieriStessoTipo1 %>" UseAccessibleHeader="True">
							<Columns>
								<asp:TemplateColumn>
								...
								<asp:TemplateColumn HeaderText="Con">
									...
									<EditItemTemplate>
										<asp:DropDownList id=ddlDestinatarioCambioTurno runat="server" DataMember="dbo_SP_ListaCambiGiornalieriStessoTipo" DataSource="<%#DsListaTurniStessoTipo1 %>" DataTextField="DESCR" DataValueField="TITIPL">
										</asp:DropDownList>
									</EditItemTemplate>
								</asp:TemplateColumn>
			...
			<asp:customvalidator id="cvTipoUtente" runat="server" Display="None" ErrorMessage="Solamente gli accertatori possono richiedere congedi e cambi turno."></asp:customvalidator><asp:customvalidator id="cvOnModifica" runat="server" Display="None" ErrorMessage="Non è possibile modificare questa richiesta perché non sei tu il richiedente oppure perché è stata accettata o rifiiutata."></asp:customvalidator><asp:customvalidator id="cvOnDelete" runat="server" Display="None" ErrorMessage="Non è possibile eliminare questa richiesta perché non sei tu il richiedente oppure perché è stata approvata o respinta."></asp:customvalidator></form>
	</body>
</HTML>
